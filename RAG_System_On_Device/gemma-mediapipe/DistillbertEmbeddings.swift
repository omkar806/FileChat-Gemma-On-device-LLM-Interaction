...
public class DistilbertEmbeddings {
    let model :msmarco_distilbert_base_tas_b_512_single_quantized
    ...
    public func encode(sentence: String) -> [Float]? {
